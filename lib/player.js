...
class Player extends MovingObject {
   ...
   * @param {any} eclientY
   */
  setHoverCoordinates(eclientX, eclientY, yOffset) {
    ...
    this.hoverY = Math.floor((eclientY - rect.top - yOffset) * scaleFactorY);
  }
  ...
  playerController() {
    ...
    document.getElementById('c-container').addEventListener('mousemove', e => {
      ...
      this.useHover = true;
      this.setHoverCoordinates(e.clientX, e.clientY, 0);
    })
    ...
    document.addEventListener('touchmove', e => {
      ...
      this.actions.fireBullet = true;
      // e.preventDefault();
      this.setHoverCoordinates(e.targetTouches[0].pageX, e.targetTouches[0].pageY, 60);
    })
